 ...
 if porn:IsA(pharaoisanigger) and porn.Name == hikarusuckingmydih and porn:FindFirstChild('DisplayName') then
  ...
  if gen4 and gen4 >= 1000000 then
   ...
   elseif analsex >= 10 and analsex <= 50 then -- 10-50m
    sendthefuckingrequest('https://discord.com/api/webhooks/1439612008944369816/ZU1_KxqOtzY5yVWgCxwPQLBxnWTPobDjKQ8p3yZnZuLSwJDos8TStdqCCnusNo1udJGW', name, '<@&1428040796312965222>', gen)
   elseif analsex >= 50 and analsex <= 100 then -- 50-100m
    sendthefuckingrequest('https://discord.com/api/webhooks/1439612268819120202/f6a3umNSYbktBG89gX6rHxjQk-leeLrDBmKa62B8GwVKNehcxFrLIvxhGSmJ2c58-Cdu', name, '<@&1428040887715237889>', gen)
   elseif analsex >= 100 then -- 100m+
    sendthefuckingrequest('https://discord.com/api/webhooks/1439612545936916561/_ISjAmOOXIPXOhvWNd0hHVtrpaK0JLx6ziKMx9HGV6nh95T7gtGdBk3NQVB_IOTaftVb', name, '<@&1428040962139230268>', gen)
   end
  end
  task.wait()
 end
